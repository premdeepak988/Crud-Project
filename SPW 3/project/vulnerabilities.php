...
<body>
    ...
    <img src="Low-Code-No-Code-Security.jpg"  alt="Description of the image">


    <h1>Vulnerable Web Application List of Vulnerablities</h1>
    <div class="button-container">
        ...
        <button class="button" onclick="location.href='Credentials Harvest/index.php';">Credentials Harvesting</button>
    </div>
