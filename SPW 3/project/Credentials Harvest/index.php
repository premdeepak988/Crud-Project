...
<head>
    ...
    <style>
        ...
        img {
            ...
            max-height: 70vh; /* Set a maximum height to avoid excessive height on smaller screens */
...
<body>
    ...
    <img src="cr2.jpg"  alt="Description of the image">

    <h1>Greetings, Credentials Harvesting Vulnerability </h1>
    <div class="button-container">
        ...
        <input type="text" id="inputField" name="pswd" >
...
<?php
  ...
  if(isset($_POST["sub"])){
    ...
    $selectQuery = "SELECT * FROM user WHERE name ='$namee'";
    ...
    if (mysqli_num_rows($selectResult) > 0) {
        ...
        while ($row = mysqli_fetch_assoc($selectResult)) {
            echo "<li>Name: " . $row["name"] . ", Password: " . $row["password"] . "</li>";
        }
        echo "</ul>";
    } else {
        echo "0 results";
