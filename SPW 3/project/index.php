...
<body>
 ...
 <p>
        Vulnerable Web Application (VWA) is a purpose-built web application aimed at testing DAST (Dynamic Application Security Testing) tools and providing valuable experience to individuals interested in web cybersecurity. Developed using PHP and SQL, VWA contains a collection of deliberately vulnerable pages, including exploits like SQL injection (SQL), Cross-Site Scripting (XSS), and OS command injection. As we progress, we plan to incorporate additional vulnerabilities, broadening the application's educational scope.
        <br><br>
        Operating VWA is simple; first, you create a database named "<strong>OSTE</strong>" and then you can launch the application and explore its various functionalities, including examining the complete database.
        <br><br>
