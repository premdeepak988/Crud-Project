...
<?php
  ...
  if(isset($_POST["sub"])){
    ...
    // sqli query is below
    //$sql3 = "SELECT * FROM books";//String
	
    // Fetch messages from the "comontair" table, removed sql injection as it was getting all book from database
    $sql3 = "SELECT * FROM books WHERE author='$name'";//String
